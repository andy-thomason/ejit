...
use crate::{ethereum::crypto::hash::Hash32, ethereum::ethereum_rlp::rlp, ethereum::ethereum_types::{bytes::{Bytes, Bytes32}, numeric::{Uint, U256}}, ethereum::cancun::fork_types::{Account, Root}};

const EMPTY_TRIE_ROOT : Root = Root(Hash32(Bytes32([0x56,0xe8,0x1f,0x17,0x1b,0xcc,0x55,0xa6,0xff,0x83,0x45,0xe6,0x92,0xc0,0xf8,0x6e,0x5b,0x48,0xe0,0x1b,0x99,0x6c,0xad,0xc0,0x01,0x62,0x2f,0xb5,0xe3,0x63,0xb4,0x21])));
...
struct LeafNode {
    rest_of_key: Bytes,
    value: Box<dyn rlp::Extended>,
}

/// Extension node in the Merkle Trie
struct ExtensionNode {
    key_segment: Bytes,
    subnode: Box<dyn rlp::Extended>,
}

struct BranchSubnodes([Box<dyn rlp::Extended>; 16]);
