...
pub fn gen_vector_aarch64(code: &mut Vec<u8>, i: Ins) -> Result<(), Error> {
    ...
    match i {
        ...
        Vst(F32, V32, v, r, imm) => vgenmem(code, 0xbc001000-0x1000, v, r, imm, &i), //     1350:	bc001000 	stur	s0, [x0, #1]
        Vst(S8, V64, v, r, imm) => vgenmem(code, 0xfc001000-0x1000, v, r, imm, &i), //     1358:	fc001000 	stur	d0, [x0, #1]
        Vst(U8, V64, v, r, imm) => vgenmem(code, 0xfc001000-0x1000, v, r, imm, &i), //     1360:	fc001000 	stur	d0, [x0, #1]
        Vst(S16, V64, v, r, imm) => vgenmem(code, 0xfc001000-0x1000, v, r, imm, &i), //     1368:	fc001000 	stur	d0, [x0, #1]
        Vst(U16, V64, v, r, imm) => vgenmem(code, 0xfc001000-0x1000, v, r, imm, &i), //     1370:	fc001000 	stur	d0, [x0, #1]
        Vst(S32, V64, v, r, imm) => vgenmem(code, 0xfc001000-0x1000, v, r, imm, &i), //     1378:	fc001000 	stur	d0, [x0, #1]
        Vst(U32, V64, v, r, imm) => vgenmem(code, 0xfc001000-0x1000, v, r, imm, &i), //     1380:	fc001000 	stur	d0, [x0, #1]
        Vst(S64, V64, v, r, imm) => vgenmem(code, 0xfc001000-0x1000, v, r, imm, &i), //     1388:	fc001000 	stur	d0, [x0, #1]
        Vst(U64, V64, v, r, imm) => vgenmem(code, 0xfc001000-0x1000, v, r, imm, &i), //     1390:	fc001000 	stur	d0, [x0, #1]
        Vst(F32, V64, v, r, imm) => vgenmem(code, 0xfc001000-0x1000, v, r, imm, &i), //     1398:	fc001000 	stur	d0, [x0, #1]
        Vst(F64, V64, v, r, imm) => vgenmem(code, 0xfc001000-0x1000, v, r, imm, &i), //     13a0:	fc001000 	stur	d0, [x0, #1]
        Vst(S8, V128, v, r, imm) => vgenmem(code, 0x3c801000-0x1000, v, r, imm, &i), //     13a8:	3c801000 	stur	q0, [x0, #1]
        Vst(U8, V128, v, r, imm) => vgenmem(code, 0x3c801000-0x1000, v, r, imm, &i), //     13b0:	3c801000 	stur	q0, [x0, #1]
        Vst(S16, V128, v, r, imm) => vgenmem(code, 0x3c801000-0x1000, v, r, imm, &i), //     13b8:	3c801000 	stur	q0, [x0, #1]
        Vst(U16, V128, v, r, imm) => vgenmem(code, 0x3c801000-0x1000, v, r, imm, &i), //     13c0:	3c801000 	stur	q0, [x0, #1]
        Vst(S32, V128, v, r, imm) => vgenmem(code, 0x3c801000-0x1000, v, r, imm, &i), //     13c8:	3c801000 	stur	q0, [x0, #1]
        Vst(U32, V128, v, r, imm) => vgenmem(code, 0x3c801000-0x1000, v, r, imm, &i), //     13d0:	3c801000 	stur	q0, [x0, #1]
        Vst(S64, V128, v, r, imm) => vgenmem(code, 0x3c801000-0x1000, v, r, imm, &i), //     13d8:	3c801000 	stur	q0, [x0, #1]
        Vst(U64, V128, v, r, imm) => vgenmem(code, 0x3c801000-0x1000, v, r, imm, &i), //     13e0:	3c801000 	stur	q0, [x0, #1]
        Vst(F32, V128, v, r, imm) => vgenmem(code, 0x3c801000-0x1000, v, r, imm, &i), //     13e8:	3c801000 	stur	q0, [x0, #1]
        Vst(F64, V128, v, r, imm) => vgenmem(code, 0x3c801000-0x1000, v, r, imm, &i), //     13f0:	3c801000 	stur	q0, [x0, #1]
        Vld(F32, V32, v, r, imm) => vgenmem(code, 0xbc402000-0x1000, v, r, imm, &i), //     13f8:	bc402000 	ldur	s0, [x0, #2]
        Vld(S8, V64, v, r, imm) => vgenmem(code, 0xfc401000-0x1000, v, r, imm, &i), //     1400:	fc401000 	ldur	d0, [x0, #1]
        Vld(U8, V64, v, r, imm) => vgenmem(code, 0xfc401000-0x1000, v, r, imm, &i), //     1408:	fc401000 	ldur	d0, [x0, #1]
        Vld(S16, V64, v, r, imm) => vgenmem(code, 0xfc401000-0x1000, v, r, imm, &i), //     1410:	fc401000 	ldur	d0, [x0, #1]
        Vld(U16, V64, v, r, imm) => vgenmem(code, 0xfc401000-0x1000, v, r, imm, &i), //     1418:	fc401000 	ldur	d0, [x0, #1]
        Vld(S32, V64, v, r, imm) => vgenmem(code, 0xfc401000-0x1000, v, r, imm, &i), //     1420:	fc401000 	ldur	d0, [x0, #1]
        Vld(U32, V64, v, r, imm) => vgenmem(code, 0xfc401000-0x1000, v, r, imm, &i), //     1428:	fc401000 	ldur	d0, [x0, #1]
        Vld(S64, V64, v, r, imm) => vgenmem(code, 0xfc401000-0x1000, v, r, imm, &i), //     1430:	fc401000 	ldur	d0, [x0, #1]
        Vld(U64, V64, v, r, imm) => vgenmem(code, 0xfc401000-0x1000, v, r, imm, &i), //     1438:	fc401000 	ldur	d0, [x0, #1]
        Vld(F32, V64, v, r, imm) => vgenmem(code, 0xfc401000-0x1000, v, r, imm, &i), //     1440:	fc401000 	ldur	d0, [x0, #1]
        Vld(F64, V64, v, r, imm) => vgenmem(code, 0xfc401000-0x1000, v, r, imm, &i), //     1448:	fc401000 	ldur	d0, [x0, #1]
        Vld(S8, V128, v, r, imm) => vgenmem(code, 0x3cc01000-0x1000, v, r, imm, &i), //     1450:	3cc01000 	ldur	q0, [x0, #1]
        Vld(U8, V128, v, r, imm) => vgenmem(code, 0x3cc01000-0x1000, v, r, imm, &i), //     1458:	3cc01000 	ldur	q0, [x0, #1]
        Vld(S16, V128, v, r, imm) => vgenmem(code, 0x3cc01000-0x1000, v, r, imm, &i), //     1460:	3cc01000 	ldur	q0, [x0, #1]
        Vld(U16, V128, v, r, imm) => vgenmem(code, 0x3cc01000-0x1000, v, r, imm, &i), //     1468:	3cc01000 	ldur	q0, [x0, #1]
        Vld(S32, V128, v, r, imm) => vgenmem(code, 0x3cc01000-0x1000, v, r, imm, &i), //     1470:	3cc01000 	ldur	q0, [x0, #1]
        Vld(U32, V128, v, r, imm) => vgenmem(code, 0x3cc01000-0x1000, v, r, imm, &i), //     1478:	3cc01000 	ldur	q0, [x0, #1]
        Vld(S64, V128, v, r, imm) => vgenmem(code, 0x3cc01000-0x1000, v, r, imm, &i), //     1480:	3cc01000 	ldur	q0, [x0, #1]
        Vld(U64, V128, v, r, imm) => vgenmem(code, 0x3cc01000-0x1000, v, r, imm, &i), //     1488:	3cc01000 	ldur	q0, [x0, #1]
        Vld(F32, V128, v, r, imm) => vgenmem(code, 0x3cc01000-0x1000, v, r, imm, &i), //     1490:	3cc01000 	ldur	q0, [x0, #1]
        Vld(F64, V128, v, r, imm) => vgenmem(code, 0x3cc01000-0x1000, v, r, imm, &i), //     1498:	3cc01000 	ldur	q0, [x0, #1]
        Vrecpe(F32, V32, dest, src) => vgen2(code, 0x5ea1d800-0, dest, src, &i), //     14a0:	5ea1d800 	frecpe	s0, s0
        Vrecpe(F64, V64, dest, src) => vgen2(code, 0x5ee1d800-0, dest, src, &i), //     14a8:	5ee1d800 	frecpe	d0, d0
        Vrecpe(F32, V64, dest, src) => vgen2(code, 0x0ea1d800-0, dest, src, &i), //     14b0:	0ea1d800 	frecpe	v0.2s, v0.2s
        Vrecpe(F32, V128, dest, src) => vgen2(code, 0x4ea1d800-0, dest, src, &i), //     14b8:	4ea1d800 	frecpe	v0.4s, v0.4s
        Vrecpe(F64, V128, dest, src) => vgen2(code, 0x4ee1d800-0, dest, src, &i), //     14c0:	4ee1d800 	frecpe	v0.2d, v0.2d
        Vrsqrte(F32, V32, dest, src) => vgen2(code, 0x7ea1d800-0, dest, src, &i), //     14c8:	7ea1d800 	frsqrte	s0, s0
        Vrsqrte(F64, V64, dest, src) => vgen2(code, 0x7ee1d800-0, dest, src, &i), //     14d0:	7ee1d800 	frsqrte	d0, d0
        Vrsqrte(F32, V64, dest, src) => vgen2(code, 0x2ea1d800-0, dest, src, &i), //     14d8:	2ea1d800 	frsqrte	v0.2s, v0.2s
        Vrsqrte(F32, V128, dest, src) => vgen2(code, 0x6ea1d800-0, dest, src, &i), //     14e0:	6ea1d800 	frsqrte	v0.4s, v0.4s
        Vrsqrte(F64, V128, dest, src) => vgen2(code, 0x6ee1d800-0, dest, src, &i), //     14e8:	6ee1d800 	frsqrte	v0.2d, v0.2d
